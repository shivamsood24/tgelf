                            ...
                            <div class="column-content">
                                <div class="column-slider">
                                    <ul>
                                        ...
                                        <li>
  <label>
    <input type="checkbox" name="category:industry[]" value="5" class="filter" data-url-title="advanced-manufacturing">
    Advanced Manufacturing</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="6" class="filter" data-url-title="aerospace">
    Aerospace</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="7" class="filter" data-url-title="ai-and-machine-learning">
    AI and Machine Learning</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="8" class="filter" data-url-title="automotive">
    Automotive</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="9" class="filter" data-url-title="biotech">
    Biotech</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="10" class="filter" data-url-title="commerce-and-marketplaces">
    Commerce and Marketplaces</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="11" class="filter" data-url-title="consumer-goods">
    Consumer Goods</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="12" class="filter" data-url-title="data-and-analytics">
    Data and Analytics</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="13" class="filter" data-url-title="developer-tools">
    Developer Tools</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="14" class="filter" data-url-title="education">
    Education</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="15" class="filter" data-url-title="energy">
    Energy</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="16" class="filter" data-url-title="enterprise-software">
    Enterprise Software</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="17" class="filter" data-url-title="environmental-engineering-and-resource-scarcity">
    Environmental Engineering and Resource Scarcity</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="18" class="filter" data-url-title="food-and-agriculture">
    Food and Agriculture</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="19" class="filter" data-url-title="gaming-and-entertainment">
    Gaming and Entertainment</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="20" class="filter" data-url-title="government-and-public-sector">
    Government and Public Sector</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="21" class="filter" data-url-title="healthcare">
    Healthcare</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="22" class="filter" data-url-title="information-privacy-and-security">
    Information Privacy and Security</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="23" class="filter" data-url-title="information-technology">
    Information Technology</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="24" class="filter" data-url-title="infrastructure-and-urban-planning">
    Infrastructure and Urban Planning</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="25" class="filter" data-url-title="internet-of-everything">
    Internet of Everything</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="26" class="filter" data-url-title="media-and-communications">
    Media and Communications</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="27" class="filter" data-url-title="network-infrastructure-and-telecommunications">
    Network Infrastructure and Telecommunications</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="85" class="filter" data-url-title="other">
    Other</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="28" class="filter" data-url-title="payments-banking-and-financial-management">
    Payments, Banking and Financial Management</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="29" class="filter" data-url-title="robotics">
    Robotics</label>
</li>
<li>
  <label>
    <input type="checkbox" name="category:industry[]" value="30" class="filter" data-url-title="transportation-and-logistics">

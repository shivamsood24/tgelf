 ...
 <div class="container login-container"  style="margin-bottom: 10%;">
    ...
    <hr style="border-top: 3px solid #194759;">
    <br><br><br><br>
    <div class="row">
    ...
    <fieldset class="f1" >
        <div class="row col-md-12 ">
             <h1 align="center" style="color: #A83334;">"A week long outward bound trip, focussing on service, and also
on bonding within the new batch of the leaders forum members."</h1>
    <hr style="border-top: 3px solid #194759;">
        ...
        <fieldset class="f2" style="display:none">
            <div class="row" id="#reg1">
               <h1 align="center" style="color: #A83334;">"Every forum member chooses one of these summers 
...
on external leadership. The remaining 4 weeks will involve working with the foundation."</h1>
    <hr style="border-top: 3px solid #194759;">
            </div>
        </fieldset>
    <fieldset class="f3" style="display:none">
        <div class="row">
             ...
             <h1 align="center" style="color: #A83334;">"tGELF helps the members of the leaders forum in getting internship 
opportunities in their areas of interest, through a structured and a regulated process."</h1>
    <hr style="border-top: 3px solid #194759;">
        </div>
    </fieldset>
    <fieldset class="f4" style="display:none">
        <div class="row">
             ...
             <h1 align="center" style="color: #A83334;">"After graduation, tGELF offers a fellowship programme to interested

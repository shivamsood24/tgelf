...
<body>
   <section id="header">
            ...
            <div class="content-wrapper">
                <a href="#" class="search-icon" id="main-search-trigger">Search</a>
                <header>
                    <h1 id="logo"><a href="index.html" title="Kairos">Kairos</a></h1>
                </header>
                <a href="regions.html" class="globe-icon">Regions</a>               
